...
\subtitle{Lecture 2 (Part 1) --- Surrogate models and Gaussian processes for economics and finance}
...
\vspace{0.3em}
\begin{center}
{\scriptsize Hands-on: \texttt{01\_Surrogate\_Primer.ipynb} (main part); notebooks \texttt{02\_GP\_and\_BAL.ipynb} and \texttt{03\_Deep\_Kernel\_Learning.ipynb} accompany the appendix.}
\end{center}
\end{frame}
...
\end{itemize}
\vspace{0.3em}
{\small The Gaussian-process machinery behind several of these applications (GP regression, active learning) is developed in the \emphc{appendix} and in notebooks \texttt{02\_GP\_and\_BAL.ipynb} and \texttt{03\_Deep\_Kernel\_Learning.ipynb}.}
\end{frame}
...
{\scriptsize See \textbf{Algorithm 2.1} in Rasmussen \& Williams (2006), and notebook \texttt{02\_GP\_and\_BAL.ipynb}.}
\end{frame}
...
\emph{(Pre-generated illustration; notebook \texttt{02\_GP\_and\_BAL.ipynb} reproduces the BAL loop itself.)}}
\end{frame}
...
\vspace{0.1cm}
{\tiny \textbf{Notebooks} (in \texttt{lectures/lecture\_2/code/}): \texttt{01\_Surrogate\_Primer}, \texttt{02\_GP\_and\_BAL}, \texttt{03\_Deep\_Kernel\_Learning}.}
