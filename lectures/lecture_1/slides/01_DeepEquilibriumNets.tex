...
\vspace{0.2em}
{\small \textbf{Note:} Training points come from the \emphc{model's own simulation}, so the network learns on the ergodic distribution of economically relevant regions.}
\end{frame}
